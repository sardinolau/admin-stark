...
class ShowList(object):
    ...
    def get_filter_linktag(self):
        ...
        for filter_field in self.config.list_filter:
            ...
            params = copy.deepcopy(self.request.GET)   #params <QueryDict: {'name': ['sarino']}>
    ...
    def get_header(self):
        ...
        for field in self.config.new_list_display():
            if callable(field):  #如果字段可以调用，则为方法
...
class ModelStark(object):
    ...
    def add_view(self, request):
        ...
        for bfield in form:
            ...
            print("related_model_name",related_model_name)
...
class StarkSite(object):
    ...
    def get_urls(self):
        ...
        for model,stark_class_obj in self._registry.items():
            model_name = model._meta.model_name #类名
            app_label = model._meta.app_label #功能名
            #分发增删改查
